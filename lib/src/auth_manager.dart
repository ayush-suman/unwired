...
/// [AuthManager] is the base class to store the authentication state and
...
/// [TokenAuthManager] is an implementation of [AuthManager] which stores
...
class TokenAuthManager extends AuthManager<String?> {
  ...
  String Function(String? token) _tokenParser = (token) => token != null ? 'Bearer $token' : '';
